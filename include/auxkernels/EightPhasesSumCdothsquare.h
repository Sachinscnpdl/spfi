...
#ifndef EIGHTPHASESSUMCDOTHSQUARE_H
#define EIGHTPHASESSUMCDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class EightPhasesSumCdothsquare;
 ...
 */
class EightPhasesSumCdothsquare : public AuxKernel
{
public:
  static InputParameters validParams();
  EightPhasesSumCdothsquare(const InputParameters & parameters);
...
#endif // EIGHTPHASESSUMCDOTHSQUARE_H
