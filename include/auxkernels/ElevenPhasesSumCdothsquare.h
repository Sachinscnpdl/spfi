...
#ifndef ELEVENPHASESSUMCDOTHSQUARE_H
#define ELEVENPHASESSUMCDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class ElevenPhasesSumCdothsquare;
 ...
 */
class ElevenPhasesSumCdothsquare : public AuxKernel
{
public:
  static InputParameters validParams();
  ElevenPhasesSumCdothsquare(const InputParameters & parameters);
...
#endif // ELEVENPHASESSUMCDOTHSQUARE_H
