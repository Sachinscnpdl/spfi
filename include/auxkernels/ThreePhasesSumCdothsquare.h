...
#ifndef THREEPHASESSUMCDOTHSQUARE_H
#define THREEPHASESSUMCDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class ThreePhasesSumCdothsquare;
 ...
 */
class ThreePhasesSumCdothsquare : public AuxKernel
{
public:
  static InputParameters validParams();
  ThreePhasesSumCdothsquare(const InputParameters & parameters);
...
#endif // THREEPHASESSUMCDOTHSQUARE_H
