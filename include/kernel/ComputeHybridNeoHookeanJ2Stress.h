...
/* This class implements the Simo-Hughes style J2 plasticity with strain-dependent Young's modulus */
class ComputeHybridNeoHookeanJ2Stress
...
public:
  ...
  ComputeHybridNeoHookeanJ2Stress(const InputParameters & parameters);
...
protected:
  ...
  // Added for strain-dependent Young's modulus
  const MaterialProperty<Real> & _E_eff;
  

private:
  /// @{ Helper (dummy) variables for iteratively updating the consistent tangent during return mapping
