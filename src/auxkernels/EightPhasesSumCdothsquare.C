...
#include "EightPhasesSumCdothsquare.h"

registerMooseObject("spfiApp", EightPhasesSumCdothsquare);

InputParameters
EightPhasesSumCdothsquare::validParams()
{
...
EightPhasesSumCdothsquare::EightPhasesSumCdothsquare(const InputParameters & parameters)
...
Real
EightPhasesSumCdothsquare::computeValue()
{
  return _var1[_qp]*(_prop_h1[_qp]*_prop_h1[_qp]+_prop_h2[_qp]*_prop_h2[_qp]+_prop_h3[_qp]*_prop_h3[_qp]+_prop_h4[_qp]*_prop_h4[_qp]+_prop_h5[_qp]*_prop_h5[_qp]+_prop_h6[_qp]*_prop_h6[_qp]+_prop_h7[_qp]*_prop_h7[_qp]+_prop_h8[_qp]*_prop_h8[_qp]) ;
}
