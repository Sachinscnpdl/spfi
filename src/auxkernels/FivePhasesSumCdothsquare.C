...
#include "FivePhasesSumCdothsquare.h"

registerMooseObject("spfiApp", FivePhasesSumCdothsquare);

InputParameters
FivePhasesSumCdothsquare::validParams()
{
...
FivePhasesSumCdothsquare::FivePhasesSumCdothsquare(const InputParameters & parameters)
...
Real
FivePhasesSumCdothsquare::computeValue()
{
