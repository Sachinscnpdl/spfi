...
#include "SevenPhasesSumCdothsquare.h"

registerMooseObject("spfiApp", SevenPhasesSumCdothsquare);

InputParameters
SevenPhasesSumCdothsquare::validParams()
{
...
SevenPhasesSumCdothsquare::SevenPhasesSumCdothsquare(const InputParameters & parameters)
...
Real
SevenPhasesSumCdothsquare::computeValue()
{
