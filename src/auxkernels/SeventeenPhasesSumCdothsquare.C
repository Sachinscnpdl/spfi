...
#include "SeventeenPhasesSumCdothsquare.h"

registerMooseObject("spfiApp", SeventeenPhasesSumCdothsquare);

InputParameters
SeventeenPhasesSumCdothsquare::validParams()
{
  ...
  params.addRequiredParam<MaterialPropertyName>("h12_name","Switching function of eta12");
  params.addRequiredParam<MaterialPropertyName>("h13_name","Switching function of eta13");
  params.addRequiredParam<MaterialPropertyName>("h14_name","Switching function of eta14");
  params.addRequiredParam<MaterialPropertyName>("h15_name","Switching function of eta15");
  params.addRequiredParam<MaterialPropertyName>("h16_name","Switching function of eta16");
  params.addRequiredParam<MaterialPropertyName>("h17_name","Switching function of eta17");

  return params;
}

SeventeenPhasesSumCdothsquare::SeventeenPhasesSumCdothsquare(const InputParameters & parameters)
  : AuxKernel(parameters),
    ...
    _prop_h13(getMaterialProperty<Real>("h13_name")),
    _prop_h14(getMaterialProperty<Real>("h14_name")),
    _prop_h15(getMaterialProperty<Real>("h15_name")),
    _prop_h16(getMaterialProperty<Real>("h16_name")),
    _prop_h17(getMaterialProperty<Real>("h17_name"))
{
}

Real
SeventeenPhasesSumCdothsquare::computeValue()
{
  return _var1[_qp]*(_prop_h1[_qp]*_prop_h1[_qp]+_prop_h2[_qp]*_prop_h2[_qp]+_prop_h3[_qp]*_prop_h3[_qp]+_prop_h4[_qp]*_prop_h4[_qp]+_prop_h5[_qp]*_prop_h5[_qp]+_prop_h6[_qp]*_prop_h6[_qp]+_prop_h7[_qp]*_prop_h7[_qp]+_prop_h8[_qp]*_prop_h8[_qp]+_prop_h9[_qp]*_prop_h9[_qp]+_prop_h10[_qp]*_prop_h10[_qp]+_prop_h11[_qp]*_prop_h11[_qp]+_prop_h12[_qp]*_prop_h12[_qp]+_prop_h13[_qp]*_prop_h13[_qp]+_prop_h14[_qp]*_prop_h14[_qp]+_prop_h15[_qp]*_prop_h15[_qp]+_prop_h16[_qp]*_prop_h16[_qp]+_prop_h17[_qp]*_prop_h17[_qp]) ;
}
