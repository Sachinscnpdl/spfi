...
#include "ThreePhasesSumCdothsquare.h"

registerMooseObject("spfiApp", ThreePhasesSumCdothsquare);

InputParameters
ThreePhasesSumCdothsquare::validParams()
{
...
ThreePhasesSumCdothsquare::ThreePhasesSumCdothsquare(const InputParameters & parameters)
...
Real
ThreePhasesSumCdothsquare::computeValue()
{
